          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <Input 
                ...
                className={`bg-gray-50 h-12 text-black placeholder:text-gray-500 ${showPasswordError ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
                value={password}
            ...
            <div>
              ...
              <Input 
                ...
                className={`bg-gray-50 h-12 text-black placeholder:text-gray-500 ${showConfirmPasswordError ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
