    ...
    <div className="bg-gray-50 min-h-screen flex justify-center items-center px-4 py-8">
      ...
      <div className="w-full max-w-md mx-auto">
        <div className="bg-white w-full overflow-y-auto px-6 sm:px-8 pt-8 pb-8 rounded-lg shadow-lg">
          ...
          <h1 className="text-2xl font-bold mb-2 text-center text-black">Create an account</h1>
          <p className="text-gray-700 text-sm mb-4 text-center">Create an account to access easy loans and smart investments</p>
          ...
          <form className="space-y-3 pb-4" onSubmit={handleSubmit}>
            <div className="space-y-2">
              ...
              <Input 
                ...
                className={`bg-gray-50 text-black placeholder:text-gray-500 ${showErrors.firstName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                className={`bg-gray-50 text-black placeholder:text-gray-500 ${showErrors.lastName ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                className={`bg-gray-50 text-black placeholder:text-gray-500 ${showErrors.email ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                className={`bg-gray-50 text-black placeholder:text-gray-500 ${showErrors.password ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                className={`bg-gray-50 text-black placeholder:text-gray-500 ${showErrors.confirmPassword ? 'border-red-500 focus-visible:ring-red-500' : ''}`}
            ...
            <div className="space-y-2">
              <Label htmlFor="referralCode" className="text-gray-800 font-medium">Referral code (Optional)</Label>
              <Input 
                id="referralCode" 
                placeholder="Enter referral code" 
                className="bg-gray-50 text-black placeholder:text-gray-500"
